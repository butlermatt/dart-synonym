...
$.getUrl = function(url, onSuccess) {
  ...
  get.open$2('GET', url);
  $.add$1(get.get$on().get$readyStateChange(), new $.getUrl_anon(get, onSuccess));
  get.send$0();
};
