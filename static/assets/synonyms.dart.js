...
$$._HashTable = {"": "Object;_table>,_capacity,_entryCount,_deletedCount,_modificationCount>,_container",
  ...
  _clear$0: function() {
    ...
    if ($.$$eq$o(this.get$_elementCount(), 0) === true)
      return;
    for (var i = 0; $.CONSTANT7.$lt(i, $.get$length$as(this._table)); ++i)
...
$$._LinkedHashTable = {"": "_HashTable;_table,_capacity,_entryCount,_deletedCount,_modificationCount,_container",
  ...
  _clear$0: function() {
    ...
    for (var i = this.get$_entrySize(); $.CONSTANT7.$lt(i, $.get$length$as(this._table)); ++i)
      $.$$indexSet$a(this._table, i, null);
    this._deletedCount = 0;
    this._entryCount = 0;
    this._recordModification$0();
...
$$._FrozenElementListIterator = {"": "Object;_list,_liblib2$_index,_current",
  moveNext$0: function() {
    ...
    this._liblib2$_index = t1.get$length();
    this._current = null;
    return false;
  },
...
$$._AttributeClassSet = {"": "CssClassSet;_liblib1$_element",
  readClasses$0: function() {
    ...
    classname = this._liblib1$_element.get$attributes().$index("class");
    s = $.LinkedHashSet$();
    if (classname == null)
      return s;
  ...
  writeClasses$1: function(s) {
    this._liblib1$_element.get$attributes().$indexSet("class", $.join$1$a(s, " "));
  }
};

$$.main_anon = {"": "Closure;lang_0",
  call$1: function(contents) {
    $.$$indexSet$a($.get$synonymXmls(), this.lang_0, contents);
    $.processXml("js");
  }
};
...
$.processXml = function(defaultLang) {
  ...
  if ($.$$eq$o($.get$length$as($.get$synonymXmls()), 4) !== true || $.xsltContents == null)
    return;
  processor = new XSLTProcessor();
  processor.importStylesheet($.xsltContents);
  for (t1 = $.get$iterator$a($.get$synonymXmls().get$keys()); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
    synonym = $.$$index$as($.get$synonymXmls(), t2);
    $.$$indexSet$a($.get$synonymHtmls(), t2, processor.transformToFragment(synonym, document));
  }
...
$.displaySynonyms = function(lang) {
  ...
  dartSynonyms = $.$$index$as($.get$synonymHtmls(), "dart");
  otherSynonyms = $.$$index$as($.get$synonymHtmls(), lang);
  for (t1 = dartSynonyms.queryAll$1(".synonym").get$iterator(); t1.moveNext$0();) {
    t2 = t1.get$current();
    destination0 = t2.query$1(".codes");
    code = otherSynonyms.query$1(".synonym[id=\"" + $.S(t2.get$attributes().$index("id")) + "\"] .codes .span8");
    if (code != null)
      destination0.get$nodes().add$1(code);
    else {
      span8 = document.createElement("div");
      $.add$1$a(span8.get$classes(), "span8");
      pre = document.createElement("pre");
      pre.set$text("// No equivalent synonym found.");
      span8.get$nodes().add$1(pre);
      destination0.get$nodes().add$1(span8);
    }
  }
  destination.set$innerHtml("");
  destination.get$nodes().add$1(dartSynonyms);
...
$.main = function() {
  var t1, t2, select;
  for (t1 = $.CONSTANT.get$keys().get$iterator(); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
...
$.List_List$fixedLength$bailout = function(state0, $length, fill, result) {
  var t1, i;
  if ($.$$eq$o($length, 0) !== true && fill != null)
    for (t1 = $.getInterceptor$as(result), i = 0; $.CONSTANT7.$lt(i, t1.get$length(result)); ++i)
...
$.CONSTANT15 = Isolate.makeConstantList(["dart", "js", "csharp", "python"]);
...
$.CONSTANT11 = new $.EventStreamProvider("readystatechange");
$.CONSTANT = new $.ConstantMap(4, {dart: "assets/dart-samples.xml", js: "assets/js-samples.xml", csharp: "assets/csharp-samples.xml", python: "assets/python-samples.xml"}, $.CONSTANT15);
