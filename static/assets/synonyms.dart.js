...
$$.ListQueue = {"": "Collection;_table>,_head,_tail,_modificationCount>",
  ...
  elementAt$1: function(index) {
    ...
    if (!(index < 0)) {
      t1 = this.get$length();
      if (typeof t1 !== "number")
        return this.elementAt$1$bailout1(2, index, t1, $.CONSTANT3);
      t1 = index > t1;
    } else
      t1 = true;
    if (t1)
...
$$._ListQueueIterator = {"": "Object;_queue,_end,_modificationCount>,_liblib4$_position,_current",
  get$current: function() {
...
$$._HashTable = {"": "Object;_table>,_capacity,_entryCount,_deletedCount,_modificationCount>,_container",
  ...
  _addAllEntries$1$bailout: function(state0, oldTable) {
    ...
    i = 0;
    while ($.CONSTANT3.$lt(i, t1.get$length(oldTable))) {
...
$$._HashTableIterable = {"": "Iterable;_hashTable>",
  ...
  forEach$1$bailout1: function(state0, action, entrySize, t1, table) {
    ...
    offset = 0;
    while ($.CONSTANT3.$lt(offset, t2.get$length(table))) {
...
$$._HashTableIterator = {"": "Object;_hashTable>,_modificationCount>",
  moveNext$0: function() {
    ...
    while (true) {
      ...
      if (!t1._isFree$1(entry)) {
        this._current = this._valueAt$2(t3, entry);
        return true;
      }
    }
    this._current = null;
          ...
          while (true)
            switch (state0) {
              ...
              case 5:
                ...
                if (!t1._isFree$1(entry)) {
                  this._current = this._valueAt$2(currentOffset, entry);
                  return true;
                }
            }
        this._current = null;
...
$$._HashTableKeyIterator = {"": "_HashTableIterator;_hashTable,_modificationCount,_offset,_current",
  _valueAt$2: function(offset, key) {
    if (key === $.CONSTANT4)
      return;
    return key;
...
$$._HashTableValueIterator = {"": "_HashTableIterator;_entryIndex,_hashTable,_modificationCount,_offset,_current",
  _valueAt$2: function(offset, key) {
    var t2, t4;
...
$$._LinkedHashTable = {"": "_HashTable;",
  ...
  _clear$0: function() {
    ...
    for (; $.CONSTANT3.$lt(i, $.length(this._table)); ++i)
      $.$$indexSet(this._table, i, null);
    this._deletedCount = 0;
    this._entryCount = 0;
    this._recordModification$0();
...
$$._LinkedHashTableKeyIterator = {"": "_LinkedHashTableIterator;_hashTable,_modificationCount,_offset,_current",
...
$$._LinkedHashTableValueIterator = {"": "_LinkedHashTableIterator;_valueIndex,_hashTable,_modificationCount,_offset,_current",
  _getCurrent$1: function(offset) {
...
$$._LinkedHashTableIterator = {"": "Object;_hashTable>,_modificationCount>",
  moveNext$0: function() {
    ...
    this._current = this._getCurrent$1(t2);
  ...
  moveNext$0$bailout: function(state0, t1, t2) {
    ...
    this._current = this._getCurrent$1(this._offset);
    this._offset = t1._next$1(this._offset);
    return true;
  },
  get$current: function() {
...
$$.ListIterator = {"": "Object;_iterable,_liblib2$_length,_liblib2$_index,_liblib2$_current",
  get$current: function() {
  ...
  moveNext$0: function() {
    ...
    if ($.$$eq(this._liblib2$_index, t1) === true) {
      this._liblib2$_current = null;
      return false;
    }
    this._liblib2$_current = $.elementAt(t2, this._liblib2$_index);
...
$$.MappedListIterable = {"": "ListIterable;_liblib2$_source,_f",
  ...
  get$length: function() {
    return $.length(this._liblib2$_source);
  },
  elementAt$1: function(index) {
    return this._f$1($.elementAt(this._liblib2$_source, index));
  }
};
...
$$._FrozenElementListIterator = {"": "Object;_list,_index,_liblib0$_current",
  moveNext$0: function() {
    var t1, nextIndex, t2;
    t1 = this._index;
    if (typeof t1 !== "number")
...
$$._ElementCssClassSet = {"": "CssClassSet;_element",
  readClasses$0: function() {
    var s, t1, trimmed;
    s = $.HashSet$();
    for (t1 = $.CONSTANT1.get$iterator($.split(this._element.className, " ")); t1.moveNext$0() === true;) {
...
$$.FixedSizeListIterator = {"": "Object;_array,_length,_position,_liblib0$_current",
  moveNext$0: function() {
    var t1, nextPosition;
    t1 = this._position;
    if (typeof t1 !== "number")
...
$$._AttributeClassSet = {"": "CssClassSet;_liblib$_element",
  readClasses$0: function() {
    var classname, s, t1, trimmed;
    classname = $.$$index(this._liblib$_element.get$attributes(), "class");
    s = $.HashSet$();
    if (classname == null)
      return s;
  ...
  writeClasses$1: function(s) {
    $.$$indexSet(this._liblib$_element.get$attributes(), "class", $.join(s, " "));
  }
};

$$.main_anon = {"": "Closure;lang_0",
...
$$.getUrl_anon = {"": "Closure;onSuccess_0,request_1",
  call$1: function(_) {
    var t1, t2;
    t1 = this.request_1;
    if ($.$$eq(t1.get$readyState(), 4) === true)
      t2 = $.$$eq(t1.get$status(), 200) === true || $.$$eq(t1.get$status(), 0) === true;
    else
      t2 = false;
    if (t2)
      this.onSuccess_0.call$1(t1.get$responseXml());
  },
  $is_TimerCallback1: true
};
...
$.getUrl = function(url, onSuccess) {
  ...
  request.get$onReadyStateChange().listen$1(new $.getUrl_anon(onSuccess, request));
  request.overrideMimeType("text/xml");
  request.send$0();
};

$.processXml = function(defaultLang) {
  var processor, t1, t2, synonym;
  if ($.$$eq($.length($.get$synonymXmls()), $.CONSTANT.length) !== true || $.xsltContents == null)
    return;
  processor = new XSLTProcessor();
  processor.importStylesheet($.xsltContents);
  for (t1 = $.iterator($.get$synonymXmls().get$keys()); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
    synonym = $.$$index($.get$synonymXmls(), t2);
    $.$$indexSet($.get$synonymHtmls(), t2, processor.transformToFragment(synonym, document));
  }
  $.displaySynonyms(defaultLang);
};

$.displaySynonyms = function(lang) {
  var destination, dartSynonyms, otherSynonyms, t1, t2, destination0, code, span8, pre;
  destination = document.query$1("#meat");
  dartSynonyms = $.$$index($.get$synonymHtmls(), "dart");
  otherSynonyms = $.$$index($.get$synonymHtmls(), lang);
  for (t1 = dartSynonyms.queryAll$1(".synonym").get$iterator(); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
    destination0 = t2.query$1(".codes");
    code = otherSynonyms.query$1(".synonym[id=\"" + $.S($.$$index(t2.get$attributes(), "id")) + "\"] .codes .span8");
    if (!(code == null))
      $.add(destination0.get$nodes(), code);
    else {
      span8 = document.$$dom_createElement$1("div");
      $.add(span8.get$classes(), "span8");
      pre = document.$$dom_createElement$1("pre");
      pre.set$text("// No equivalent synonym found.");
      $.add(span8.get$nodes(), pre);
      $.add(destination0.get$nodes(), span8);
    }
  }
  destination.set$innerHtml("");
  $.add(destination.get$nodes(), dartSynonyms);
  window.postMessage$2("code:loaded", "*");
};

$.switchLanguage = function(e) {
  $.processXml($.callTypeCast(e.get$target(), "$isSelectElement").value);
};

$.main = function() {
  var t1, t2, select;
  for (t1 = $.iterator($.CONSTANT.get$keys()); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
    $.getUrl($.CONSTANT.$index(t2), new $.main_anon(t2));
  }
  $.getUrl("assets/transform.xslt", new $.main_anon0());
  select = document.query$1(".language-choice select");
  if (select == null)
    $.Primitives_printString("did not find language choice");
  else
    select.get$onChange().listen$1($.switchLanguage);
};
...
$.unwrapException = function(ex) {
  ...
  if (ex instanceof TypeError) {
    ...
    if (t1)
      if ($.CONSTANT7.endsWith$1(message, "is null") === true || $.CONSTANT7.endsWith$1(message, "is undefined") === true || $.CONSTANT7.endsWith$1(message, "is null or undefined") === true || $.CONSTANT7.endsWith$1(message, "of undefined") === true || $.CONSTANT7.endsWith$1(message, "of null") === true)
...
$.stringContainsUnchecked = function(receiver, other, startIndex) {
  if (typeof other === "string")
    return $.$$eq($.CONSTANT7.indexOf$2(receiver, other, startIndex), -1) !== true;
    ...
    return $.iterator($.allMatches(other, $.CONSTANT7.substring$1(receiver, startIndex))).moveNext$0();
};
...
$.Error_safeToString = function(object) {
  ...
  if (typeof object === "string")
    return "\"" + $.S($.replaceAll($.replaceAll($.replaceAll($.CONSTANT7.replaceAll$2(object, "\\", "\\\\"), "\n", "\\n"), "\r", "\\r"), "\"", "\\\"")) + "\"";
...
$.CONSTANT14 = Isolate.makeConstantList(["dart", "js", "csharp", "python"]);
...
$.CONSTANT7 = new Isolate.$isolateProperties.JSString();
...
$.CONSTANT11 = new Isolate.$isolateProperties.EventStreamProvider("readystatechange");
$.CONSTANT = new Isolate.$isolateProperties.ConstantMap(4, {dart: "assets/dart-samples.xml", js: "assets/js-samples.xml", csharp: "assets/csharp-samples.xml", python: "assets/python-samples.xml"}, Isolate.$isolateProperties.CONSTANT14);
...
$.$defineNativeClass("Document", {"": "readyState>",
  ...
  query$1: function(selectors) {
    if ($.RegExp_RegExp("^#[_a-zA-Z]\\w*$", true, false).hasMatch$1(selectors))
      return this.$$dom_getElementById$1($.CONSTANT7.substring$1(selectors, 1));
  ...
  queryAll$1: function(selectors) {
    ...
    if ($.RegExp_RegExp("^\\[name=[\"'][^'\"]+['\"]\\]$", true, false).hasMatch$1(selectors)) {
      mutableMatches = this.$$dom_getElementsByName$1($.CONSTANT7.substring$2(selectors, 7, selectors.length - 2));
...
$.$defineNativeClass("Element", {"": "$$dom_children:children~,id>,innerHtml:innerHTML|,$$dom_className:className},$$dom_lastElementChild:lastElementChild~",
...
$.$defineNativeClass("XMLHttpRequest", {"": "readyState>,responseXml:responseXML~,status>",
  $$dom_addEventListener$3: function(type, listener, useCapture) {
    return this.addEventListener(type,$.convertDartClosureToJS(listener, 1),useCapture);
  },
...
(function() {
  ...
  $.dynamicSetMetadata([["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["Uint8Array", v0_Uint8Array], ["ArrayBufferView", [v0_Uint8Array, "ArrayBufferView"].join("|")], ["Blob", "Blob|File"], ["CharacterData", v5_CharacterData], ["SVGElement", v2_SvgElement], ["HTMLMediaElement", v1_MediaElement], ["Document", v6_Document], ["DocumentFragment", v4_DocumentFragment], ["Element", v3_Element], ["Node", v7_Node], ["NodeList", "NodeList|RadioNodeList"], ["Event", "Event|ProgressEvent|XMLHttpRequestProgressEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SpeechInputEvent|SpeechRecognitionError|SpeechRecognitionEvent|StorageEvent|UIEvent|TextEvent|TouchEvent|MouseEvent|WheelEvent|CompositionEvent|SVGZoomEvent|KeyboardEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitTransitionEvent|IDBVersionChangeEvent|BeforeLoadEvent|CloseEvent|WebKitAnimationEvent|CustomEvent|ErrorEvent|AudioProcessingEvent|DeviceMotionEvent|DeviceOrientationEvent|OfflineAudioCompletionEvent|HashChangeEvent|MediaKeyEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MutationEvent|OverflowEvent|PageTransitionEvent|PopStateEvent"], ["EventTarget", [v7_Node, "EventTarget|DOMWindow|XMLHttpRequest|XMLHttpRequestUpload"].join("|")]]);
})();
