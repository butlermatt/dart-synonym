...
XMLHttpRequestWrappingImplementation.prototype.get$responseXML = function() {
  return LevelDom.wrapDocument(this._ptr.get$responseXML());
}
...
function main() {
  ...
  function processXML() {
    ...
    html_get$document().query("#meat").get$nodes().add(result);
    html_get$window().postMessage("code:loaded", "*");
  }
  XMLHttpRequestWrappingImplementation.XMLHttpRequestWrappingImplementation$getTEMPNAME$factory(synonymsUrl, (function (request) {
    xmlContents = request.get$responseXML();
    processXML();
  })
  );
  XMLHttpRequestWrappingImplementation.XMLHttpRequestWrappingImplementation$getTEMPNAME$factory(transformUrl, (function (request) {
    xsltContents = request.get$responseXML();
    processXML();
  })
  );
}
...
(function(){
  ...
  var v8/*EventTarget*/ = [v3/*AbstractWorker*/,v4/*Node*/,'EventTarget|DOMApplicationCache|DOMWindow|EventSource|MessagePort|Notification|SVGElementInstance|WebSocket|XMLHttpRequest|XMLHttpRequestUpload'].join('|');
